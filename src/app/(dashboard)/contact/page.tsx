    ...
    <div className="max-w-5xl mx-auto space-y-12 pb-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
        <div className="md:col-span-5 space-y-4">
          <a href="mailto:vanenja@gmail.com" className="flex items-center gap-4 p-4 rounded-xl border border-border bg-card hover:bg-accent/50 transition-colors group">
          ...
          <a href="https://www.linkedin.com/in/privanza-wisnu/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-4 rounded-xl border border-border bg-card hover:bg-accent/50 transition-colors group">
          ...
          <a href="https://wa.me/6281285552004" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-4 rounded-xl border border-border bg-card hover:bg-accent/50 transition-colors group">
        ...
        <form onSubmit={handleSubmit} className="md:col-span-7 bg-card border border-border rounded-2xl p-6 space-y-4 shadow-sm">
          <div className="space-y-2">
          ...
          <Button 
            ...
            className="w-full sm:w-auto h-11 px-6 rounded-xl font-medium shadow-md"
          >
            {isSubmitting ? (
              <>
